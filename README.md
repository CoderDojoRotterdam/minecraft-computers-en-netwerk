# Computers en netwerken in Minecraft
...
3. Installeer Minecraft Forge door `forge-1.7.10-10.13.4.1558-1.7.10-installer-win.exe` te openen. Zorg dat de optie client geselecteerd is en druk op `OK` om de installatie te starten.
...
- Kun je de map `.minecraft` niet vinden (_Engels_)? Start Minecraft door op Play te klikken in de launcher, klik op `Options`, klik op `Resource Packs` en klik op `Open resource pack folder`. Dit opent de resourcepacks map. Ga één mapje omhoog of terug en je zit in de `.minecraft` map.
- Kun je de map `.minecraft` niet vinden (_Nederlands_)? Start Minecraft door op Play te klikken in de launcher, klik op `Instellingen`, klik op `Bronpakketten` en klik op `Map met bronpakketten openen`. Dit opent de resourcepacks map. Ga één mapje omhoog of terug en je zit in de `.minecraft` map.
